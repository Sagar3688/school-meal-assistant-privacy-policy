...
This information is used only for user authentication, account identification, displaying account information within the App, and enabling Google Drive backup functionality.

### School Information

The App may store information entered by users, including:
...
- Mid-Day Meal Teacher Name
- Mid-Day Meal Teacher Mobile Number
- Student Count Information
- Mid-Day Meal records and reports

This information is stored locally on the user's device. The App may automatically create backup copies of application data in the user's Google Drive App Data storage to support backup and recovery functionality.
...
- Display signed-in account information
- Improve application reliability and functionality
...
The App also provides optional local backup and restore features that allow users to create and restore backup files stored on their own device.
...
**Sharvansh Solutions**  
Email: smartapps.sagar@gmail.com
